...
const ACTION_HANDLERS = {
  ...
  [LOAD_RESOURCES] : (state, action) => {
    let allTraits = [{"name":"Bat-Armor MK 1","phase":"Execute the plan","cost":"","rule":"Each time this [Character] receives a [Hit], after [Block]s, [Ping]s, and [Dodge]s; roll a die. On a result of 5+, discard the [Hit].","grants":[]},
